                    ...
                    timelineData.map((item) => {
                        return (
                            <div key={item.key} className="flex gap-x-3">
                                ...
                                <div className={`relative ${item.isLastItem?"after:hidden":null} after:absolute after:top-7 after:bottom-0 after:start-3.5 after:w-px after:-translate-x-[0.5px] after:bg-gray-200`}>
